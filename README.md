...
这个仓库不是放一堆零散 prompt 的地方，而是用来分发一套真正能把营销需求推进成结果的 skill。当前核心内容是 `skills/market-kit-skills`。
...
| 能力 | 结果 |
| --- | --- |
| 营销方案 | 输出营销方案、内容规划和 campaign plan |
| 小红书内容 | 生成小红书图文、小红书笔记、标题、正文和配图 |
| 品牌表达 | 提炼人群、卖点、定位和差异化表达 |
| 参考驱动内容 | 基于资料库生成参考驱动内容 |
| 可追踪结果 | 返回文案、图片链接和网页版结果链接 |
...
> [!NOTE]
> 安装方式就是一句话：把仓库地址给 Agent，然后说“帮我安装 `market-kit-skills`”。
